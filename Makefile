...
lib: 	objs
	ar rvs libs/librebel.a tmp/rebel.o tmp/window.o tmp/shader.o tmp/sprite.o tmp/texture.o tmp/camera.o tmp/renderer.o tmp/glad.o tmp/keyboard.o tmp/mouse.o tmp/light.o tmp/material.o tmp/mesh.o tmp/model.o
