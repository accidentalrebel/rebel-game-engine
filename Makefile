OBJS = main.cpp rebel.c src/rebel.cpp src/core/window.cpp src/graphics/sprite.cpp src/input/keyboard.cpp src/scripting/scripting.cpp src/graphics/shader.cpp src/external/glad.c
